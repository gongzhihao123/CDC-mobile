...
export default {
  data () {
    return {
      imgList: [
        this.readPath + '/common/attachment?filepath=/articleimage/20/' + 1 + '.png',
        this.readPath + '/common/attachment?filepath=/articleimage/20/' + 2 + '.png',
        this.readPath + '/common/attachment?filepath=/articleimage/20/' + 3 + '.png'
      ]
    }
  }
}
